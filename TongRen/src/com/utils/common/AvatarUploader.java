...
public class AvatarUploader {
	...
	// 常量
	private final String WEB_URL = EAPIConsts.AVATAR_USER_URL; // 服务器地址
	...
	public OnFileUploadListener getmListener() {
		return mListener;
	}

	public void setmListener(OnFileUploadListener mListener) {
	 ...
	 * @param listener
	 */
	public AvatarUploader(OnFileUploadListener listener){
