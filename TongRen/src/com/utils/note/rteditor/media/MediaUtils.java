...
package com.utils.note.rteditor.media;
...
import com.utils.note.rteditor.utils.RTFileNameUtils;
...
public class MediaUtils {
    ...
    public static File createUniqueFile(File targetFolder, String originalFile, String mimeType, boolean keepOriginal) {
         ...
         */
        String extension = RTFileNameUtils.getExtension(originalFile);
        ...
        if (keepOriginal) {
            String baseName = RTFileNameUtils.getBaseName(originalFile);
