...
import com.utils.note.rteditor.api.media.RTAudioImpl;
import com.utils.note.rteditor.api.media.RTImage;
import com.utils.note.rteditor.api.media.RTImageImpl;
...
import com.utils.note.rteditor.api.media.RTVideoImpl;
...
public class RTMediaFactoryImpl implements RTMediaFactory<RTImage, RTAudio, RTVideo> {
    ...
    @Override
	/* @inheritDoc */
    public RTAudio createAudio(RTMediaSource mediaSource,String audioPath) {
        File targetFile = loadMedia(mediaSource);
        return targetFile == null ? null :
                new RTAudioImpl(targetFile.getAbsolutePath(),audioPath);
    }
    ...
    @Override
	/* @inheritDoc */
    public RTAudio createAudio(String path,String audioPath) {
        return new RTAudioImpl(path,audioPath);
    }
