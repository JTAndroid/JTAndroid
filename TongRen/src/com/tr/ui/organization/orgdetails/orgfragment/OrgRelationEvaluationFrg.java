 ...
 * 
 */
public class OrgRelationEvaluationFrg extends BaseViewPagerFragment implements
	...
	public static OrgRelationEvaluationFrg newInstance(int index) {
		OrgRelationEvaluationFrg fragment = new OrgRelationEvaluationFrg();
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		if (mIsVisibleToUser /*&& !isFirstStart*/) {
			if (homeUserId != null) {
				// 获取对该用户的评价
				OrganizationReqUtil.doFindEvaluate(getActivity(), this,
						Long.valueOf(homeUserId), false, "1", null);
				showLoadingDialog();
			} else {
				OrganizationReqUtil.doFindEvaluate(getActivity(), this,
						Long.valueOf(0), false, "1", null);
				showLoadingDialog();
			}
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.moreEvaluationLayout:// 更多评价
			...
			ENavigate.startOrgRelationMoreEvaluationActivityForResult(
						...
						if (!((DoubleTextViewTagLayout) view)
							...
							if (hasEvaluationTag(userCommentlists, content)) {
								...
								if (!TextUtils.isEmpty(homeUserId)) {
									// 请求添加评价
									OrganizationReqUtil.doAddEvaluate(
											getActivity(),
											OrgRelationEvaluationFrg.this,
											Long.valueOf(homeUserId), content, "1",
											null);
									showLoadingDialog();
								}
	...
	private boolean hasEvaluationTag(
			ArrayList<CustomerEvaluate> userCommentlists, String content) {
