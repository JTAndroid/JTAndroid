...
public class ClientDetailsParams implements Serializable{
	...
	public String createType;//判断当前客户是 用户创建还是组织创建:1用户 2组织
	// 自定义板块 
	...
	public  String  directory;//目录信息
	
	public List<CustomerTag> lableList;//客户标签
	public List<JsonObj> industryObj; //冗余行业备注
	public Area area;//客户地址
	public String isCollect;//"是否已收藏 1:收藏 0:未收藏"
	@Override
	public String toString() {
		return "ClientDetailsParams [customerId=" + customerId + ", name="
				+ name + ", shotName=" + shotName + ", type=" + type
				+ ", industrys=" + industrys + ", industryIds=" + industryIds
				+ ", isListing=" + isListing + ", stockNum=" + stockNum
				+ ", linkMobile=" + linkMobile + ", linkEmail=" + linkEmail
				+ ", phoneList=" + phoneList + ", picLogo=" + picLogo
				+ ", banner=" + banner + ", discribe=" + discribe
