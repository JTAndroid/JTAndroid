...
public class CalendarUtil {
    ...
    private boolean isGregorianLeap;//是否是润年
    private int dayOfYear;//当前天在本年中是第几天
 ...
 */
    ...
    public void setGregorian(int y, int m, int d) {
            ...
            //Log.d("xmx","3 gregorianMonth:"+gregorianMonth);
