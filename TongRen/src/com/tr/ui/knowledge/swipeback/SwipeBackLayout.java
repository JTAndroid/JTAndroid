package com.tr.ui.knowledge.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
	...
	public boolean isCanSilding = false;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (moveX - downX > mTouchSlop
					&& Math.abs((int) ev.getRawY() - downY) < mTouchSlop&&isCanSilding) {
				return true;
			}
			break;
		}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			tempX = moveX;
			if (moveX - downX > mTouchSlop
					&& Math.abs((int) event.getRawY() - downY) < mTouchSlop&&isCanSilding) {
				isSilding = true;
			}

			if (mContentView!=null&&moveX - downX >= 0 && isSilding&&isCanSilding) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (mContentView!=null&&mContentView.getScrollX() <= -viewWidth / 3&&isCanSilding) {
				isFinish = true;
				scrollRight();
			} else {
				scrollOrigin();
	...
	public void setCanSilding(boolean isCanSilding) {
		this.isCanSilding = isCanSilding;
	}
