...
public class CommumitiesPeopleAdapter extends BaseAdapter {

	private Context mContext;
	private List<DemandASSOData> conn;

	public CommumitiesPeopleAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (adata.type == 2)// 人脉
			people_type.setBackgroundResource(R.drawable.contactpeopletag);
		if (adata.type == 3)
			people_type.setBackgroundResource(R.drawable.contactfriendtag);
