...
package com.tr.ui.widgets.viewpagerheaderscroll;
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    @SuppressLint({ "InlinedApi", "NewApi" }) protected TextView createDefaultTabView(Context context) {
        TextView textView = new TextView(context);
        textView.setGravity(Gravity.CENTER);
        textView.setTextColor(R.color.hy_activity_main_bg_color);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextColor(getResources().getColorStateList(R.drawable.relation_text_tab));
