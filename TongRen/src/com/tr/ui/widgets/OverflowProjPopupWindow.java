...
public class OverflowProjPopupWindow extends PopupWindow {

	private Context mContext;
	private OnOverflowProjItemClickListener mItemClickListener;
	
	public OverflowProjPopupWindow(Context context){
		mContext = context;

		View root = LayoutInflater.from(mContext)
				.inflate(R.layout.widget_popup_overflow_proj, null);
	 ...
	 * @param listener
	 */
	public void setOnItemClickListener(OnOverflowProjItemClickListener listener){
		mItemClickListener = listener;
	}
	
	public interface OnOverflowProjItemClickListener{
		public void edit(); // 修改
