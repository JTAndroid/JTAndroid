...
//        }
    ...
    private static class AnimationHandler extends Handler {
        private WeakReference<MyWheelView> weakReference;

        public AnimationHandler(MyWheelView wheelView) {
            this.weakReference = new WeakReference<MyWheelView>(wheelView);
        }

        @Override
        public void handleMessage(Message msg) {
        	MyWheelView wheelView = weakReference.get();
