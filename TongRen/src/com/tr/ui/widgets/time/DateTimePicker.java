...
import com.tr.ui.widgets.time.MyWheelView.WheelNumericAdapter;

public class DateTimePicker extends WheelPicker<Date> {
    private MyWheelView yearView, monthView, dayView;
    private MyWheelView hourView, minuteView;
    ...
    public void setDate(long milliseconds) {
        ...
        // 添加"年"监听
        yearView.addChangingListener(new MyWheelView.OnWheelChangedListener() {
            @Override
        ...
        // 添加"月"监听
        monthView.addChangingListener(new MyWheelView.OnWheelChangedListener() {
            @Override
            public void onChanged(MyWheelView wheel, int oldValue, int newValue) {
