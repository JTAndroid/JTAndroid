 ...
 * 
 */
public class MenuRotateAndTranslateAnimation extends Animation {
     ...
     */
    public MenuRotateAndTranslateAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,
