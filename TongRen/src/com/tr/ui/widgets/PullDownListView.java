...
public class PullDownListView extends FrameLayout implements
	...
	private void addRefreshBar() {
		...
		//刷新头部的view
		view = LayoutInflater.from(getContext()).inflate(R.layout.widget_pull_list_refresh_bar,null);
		//添加view在本控件中
		addView(view);
	...
	protected void onFinishInflate() {
		...
		footer_layout = (LinearLayout) LayoutInflater.from(getContext())
				.inflate(R.layout.widget_pull_list_empty_main, null);
		foot = (LinearLayout) LayoutInflater.from(getContext()).inflate(
				R.layout.widget_pull_list_ref2, null);
		...
		if (useempty) {
			header = (LinearLayout) LayoutInflater.from(getContext()).inflate(
					R.layout.widget_pull_list_empty_main, null);
	...
	public boolean dispatchKeyEventPreIme(KeyEvent event) {
		...
		if (context != null) {
			...
			/*		EditText editText1 = (EditText) view
							.findViewById(R.id.HFIEditFeedbackComment);
