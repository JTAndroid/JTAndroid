...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private List<MainImagesItem> infos;
	...
	public void setData(List<ImageView> views, List<MainImagesItem> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<MainImagesItem> list, ImageCycleViewListener listener, int showPosition) {
...
//		for (int i = 0; i < indicators.length; i++) {
//			indicators[i]
//					.setBackgroundResource(R.drawable.icon_banner_default_tongren);
//		}
...
//					.setBackgroundResource(R.drawable.icon_point_pre);
	...
	public static interface ImageCycleViewListener {
		...
		public void onImageClick(MainImagesItem info, int postion, View imageView);
	}
