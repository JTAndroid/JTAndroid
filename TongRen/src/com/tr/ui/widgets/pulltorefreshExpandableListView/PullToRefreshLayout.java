package com.tr.ui.widgets.pulltorefreshExpandableListView;
...
public class PullToRefreshLayout extends RelativeLayout {
	...
	private boolean ishintloadmore;

	public void hintLoadMoreLayout(boolean ishintloadmore) {
//		if (ishintloadmore&&loadmoreView!=null) {
//			loadmoreView.setVisibility(View.GONE);
//		}
		this.ishintloadmore = ishintloadmore;
	}
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			} else if (pullUpY < 0 && !ishintloadmore) {
