...
public class GridviewInviteAttendeeAdapter extends BaseAdapter {
...
//	private int SCALESIZE =100;
	...
	public GridviewInviteAttendeeAdapter(Context context){
...
//			this.inviteAttendList.addAll(this.inviteAttendList.size() - 1, dataMap);
		}
...
//		activity.setGridViewParam(shareGridView, 92, 50, );
	...
	public List<JTContactMini> getList(){
		return inviteAttendList;
	}
	public void clear(){
	...
	private void setHolderView(HolderView holderView, int position){
		...
		if((inviteAttendList.size() - 1) == position){
		    ...
		    holderView.image.setImageResource(R.drawable.no_avatar_no_gender);
