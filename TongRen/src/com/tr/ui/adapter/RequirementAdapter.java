...
import com.tr.ui.adapter.MatchRequirementAdapter.ViewHolder;
...
public class RequirementAdapter extends BaseAdapter{
	...
	public RequirementAdapter(Context context,List<RequirementMini> listReqMini){
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.list_item_requirement, parent, false);
