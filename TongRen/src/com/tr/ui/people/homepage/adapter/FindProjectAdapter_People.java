package com.tr.ui.people.homepage.adapter;
 ...
 */
public class FindProjectAdapter_People extends BaseAdapter {
	private ContactsMainPageActivity.TypeItem typeItem;
	private int selectItem = 0;
	private Context cxt;
	List<Metadata> list;


	public FindProjectAdapter_People(ContactsMainPageActivity.TypeItem typeItem, List<Metadata> list,Context cxt) {
